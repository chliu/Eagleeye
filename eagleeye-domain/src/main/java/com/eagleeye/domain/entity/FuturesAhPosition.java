...
@Entity
@Table(
    name = "futures_ah_position",
    uniqueConstraints = @UniqueConstraint(
        name = "uq_futures_ah_position",
        columnNames = {"trade_date", "contract", "trader_type"}
    )
)
public class FuturesAhPosition {
    ...
    @Column(name = "trading_long_volume")  private Long tradingLongVolume;
    @Column(name = "trading_long_value")   private Long tradingLongValue;
    @Column(name = "trading_short_volume") private Long tradingShortVolume;
    @Column(name = "trading_short_value")  private Long tradingShortValue;
    @Column(name = "trading_net_volume")   private Long tradingNetVolume;
    @Column(name = "trading_net_value")    private Long tradingNetValue;

    // Open Interest Volume & Value
    @Column(name = "oi_long_volume")  private Long oiLongVolume;
    @Column(name = "oi_long_value")   private Long oiLongValue;
    @Column(name = "oi_short_volume") private Long oiShortVolume;
    @Column(name = "oi_short_value")  private Long oiShortValue;
    @Column(name = "oi_net_volume")   private Long oiNetVolume;
    @Column(name = "oi_net_value")    private Long oiNetValue;

    protected FuturesAhPosition() {}

    public FuturesAhPosition(LocalDate tradeDate, String contract, TraderType traderType) {
