...
echo ""
echo "  Collector runs Mon–Fri independently:"
echo "    13:40  market index (TWSE close)"
echo "    14:10  institutional flow (三大法人)"
echo "    21:35  margin transactions (融資融券, published 20:30–21:30)"
echo "    15:10  TAIFEX OI (未平倉口數及契約金額)"
